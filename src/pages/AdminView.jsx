                 ...
                 <table className="mt-12 w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <thead className="text-m text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400 bg-alba">
                        <tr>
                               ...
                               <th scope="col" class="px-6 py-3 font-medium text-gray-900">Id</th>
                                <th scope="col" class="px-6 py-3 font-medium text-gray-900">Name</th>
                                {/* <th scope="col" class="px-6 py-3 font-medium text-gray-900">Type Product</th>
                                <th scope="col" class="px-6 py-3 font-medium text-gray-900">Price</th> */}
                                <th scope="col" class="px-6 py-3 font-medium text-gray-900">Stock</th>

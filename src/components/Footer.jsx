    ...
    <footer className=" bg-alba">
      <div className="mx-auto w-full container">
        <div className="grid grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4">
          <div>
            <h2 className="mb-6 text-sm font-semibold text-dark uppercase">Information</h2>
            <ul className="text-dark font-light">
              <li className="mb-4">
                <a href="#" className=" hover:underline">Shipping conditions</a>
              </li>
              <li className="mb-4">
          ...
          <div>
            <h2 className="mb-6 text-sm font-semibold text-dark uppercase">My Account</h2>
            <ul className="text-dark font-light">
              <li className="mb-4">
          ...
          <div>
            <h2 className="mb-6 text-sm font-semibold text-dark uppercase">Links of Interest</h2>
            <ul className="text-dark font-light">
              <li className="mb-4">
                <a href="#" className="hover:underline">FQA</a>
              </li>
              <li className="mb-4">
      ...
      <div className="px-4 py-6 bg-orange md:flex items-center justify-between">
        ...
        <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0 mr-3">
          <a href="#" className="text-dark hover:text-gray-900 dark:hover:text-white">
...
<div className="px-4 py-6 bg-orange-300 md:flex items-center justify-between">
  <span className="text-sm text-black sm:text-center">© 2023 <a href="">Blossom</a> | All Rights Reserved.
  </span>

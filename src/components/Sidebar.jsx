...
//      function clearTable (productsData.typeProduct) {
//     //     console.log(filterType);
//     //     if (filterType != "Soap"){
//     //      document.getElementsByClassName(filterType).remove();
//     //     }
//     //     if (filterType != "Cosmetics"){
//     //      document.getElementsByClassName(filterType).remove();
//     //     }
//     //     if (filterType != "Aromatherapy"){
//     //      document.getElementsByClassName(filterType).remove();
//     //     }
//     //     if (filterType != "Hair"){
//     //      document.getElementsByClassName(filterType).remove();
...
//                 <a
//                      onClick={() => setClearType("Cosmetics")}
...
//                     <small class="text-center text-xs font-medium"> Soap </small>
//                 </a>

//                 <a
//                     onClick={() => setClearType("Aromatherapy")}
//                     class="flex aspect-square min-h-[32px] w-16 flex-col items-center justify-center gap-1 rounded-md p-1.5 text-gray-700 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-slate-800"
//                 >
